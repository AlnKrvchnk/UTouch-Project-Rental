        ...
        <div>
            ...
            {filter.microDistricts && (
                <FilterItem
                    ...
                    onChange={(value) => {
                        setFilterValue(FilterTitle.microDistricts, value);
                    }}
                />
            )}
            {filter.facilityTypes && (
                <FilterItem
                    ...
                    onChange={(value) => {
                        setFilterValue(FilterTitle.facilityTypes, value);
                    }}
                />
            )}
            {filter.price && (
            ...
            {filter.registrations && (
                <FilterItem
                    ...
                    onChange={(value) => {
                        setFilterValue(FilterTitle.registrations, value);
                    }}
                />
            )}
            {filter.benefits && (
            ...
            {filter.deliveryDates && (
                <FilterItem
                    ...
                    onChange={(value) => {
                        setFilterValue(FilterTitle.deliveryDates, value);
                    }}
                />
            )}
            {filter.paymentOptions && (
                <FilterItem
                    ...
                    onChange={(value) => {
                        setFilterValue(FilterTitle.paymentOptions, value);
                    }}
                />
            )}
            {filter.decorations && (
            ...
            {filter.distanceToTheBeach && (
                <FilterItem
                    ...
                    onChange={(value) => {
                        setFilterValue(FilterTitle.distanceToTheBeach, value);
                    }}
                />
            )}
            {filter.houseClasses && (
